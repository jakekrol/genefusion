...
parser.add_argument('--bedfile', default='./erg-tmprss2.bed')
parser.add_argument('--fusion_set', default='./fusions.tsv')
...
df_fusions.columns = ['gene_left', 'gene_right']
t_0=time.time()
df_merge = merge_fusion_set_with_bed(df_fusions, df_bed, merger='pandas')
