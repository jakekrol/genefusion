...
parser.add_argument('--fusion_set', default='./recurrent_normal_fusion_set.filtered.nohead.c1c2.tsv', help='path to fusion set file')
parser.add_argument('--bedfile', default='./grch37.genes.added.bed', help='path to bed file')
...
df_fusion_sort.drop_duplicates(inplace=True)
