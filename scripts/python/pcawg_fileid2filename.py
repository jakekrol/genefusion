...
parser = argparse.ArgumentParser(description='Map file ids to file names for pcawg')
...
parser.add_argument('-i', '--input', type=str, required=True, help='File with line delimited list of file ids')
