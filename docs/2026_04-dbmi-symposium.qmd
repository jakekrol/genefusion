...
- Genefusion mutations merge genes together
...
::: {.column width="50%"}
::: {.center}
![PCAWG recurrent fusions](./images/pcawg-recurrent-fusions-heatmap-and-legend.png){fig-align="center"}
:::
:::
::: {.column width="50%"}
...
## Gaps in recurrent fusion discovery
...
:::
::: {.column width="34%"}
![](./images/black-person-cropped.png){fig-align="center" width=65%}
:::
::::
...
- Sample aggregation amplifies fusion signal

<br>

:::: {.columns}
::: {.column width="25%"}
![](./images/black-person-cropped.png){fig-align="center" width=60%}
:::
::: {.column width="25%"}
![](./images/fractional-tumor-cells.png){fig-align="center" width=30%}
:::
::: {.column width="25%"}
![](./images/black-person-cohort.png){fig-align="center" width=80%}
:::
::: {.column width="25%"}
...
- Sample-level fusion evidence from various cancer types
