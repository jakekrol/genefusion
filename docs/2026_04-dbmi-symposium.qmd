...
::: {.small}
- Population databases are already used for *filtering* unlikely tumor-driving structural variants (SV)s
:::
...
- Using score prioritization, discovered a potential novel fusion in kidney cancer: SHPK--ITGAE
...
::: {.small}
- Intuitive scoring collapses and ranks multimodal, multi-sample fusion evidence
- Score evaluation
  - Separation of recurrent tumor & recurrent normal fusions
  - Demonstrated tissue specificity of recurrent tumor fusions
- Potential novel fusion discovery: SHPK--ITGAE in kidney cancer
  - Not reported in primary PCAWG publication
  - Visual confirmation of read support
:::
...
- More visual verification and functional analysis of putative overlooked PCAWG fusions
- Probabilistic score interpretation
  - Random gene pairs as null distribution
  - No assumption about what score values are "good/bad"
:::
